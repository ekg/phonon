...
use crate::signal_graph::{BusId, NodeId, SignalGraph};
...
pub enum ModulationTarget {
    NodeParameter { node_id: NodeId, param: String },
    BusValue(BusId),
    PatternParameter { pattern: String, param: String },
}
...
mod tests {
    ...
    fn test_add_route() {
        ...
        let route = ModulationRoute {
            ...
            destinations: vec![ModulationDestination {
