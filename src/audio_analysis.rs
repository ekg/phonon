...
impl PitchDetector {
    ...
    fn autocorrelation_pitch(&self) -> f32 {
        ...
        if best_correlation > 0.3 {  // Threshold for voiced detection
...
mod tests {
    ...
    fn test_pitch_detection_sine_wave() {
        ...
        for i in 0..4410 {  // 100ms of samples
    ...
    fn test_transient_detection() {
        ...
        assert!(no_transient < 0.1, "Should not detect transient in steady state");
    }
