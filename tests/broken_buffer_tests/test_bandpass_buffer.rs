...
fn test_bpf_cutoff_effect() {
    ...
    let bpf_low = graph.add_bandpass_node(
        Signal::Node(osc_id),
        Signal::Value(500.0),
        Signal::Value(2.0),
    );
    ...
    let bpf_high = graph.add_bandpass_node(
        Signal::Node(osc_id),
        Signal::Value(2000.0),
        Signal::Value(2.0),
    );
...
fn test_bpf_resonance_narrows_band() {
    ...
    let bpf_low_q = graph.add_bandpass_node(
        Signal::Node(osc_id),
        Signal::Value(1000.0),
        Signal::Value(0.5),
    );
    ...
    let bpf_high_q = graph.add_bandpass_node(
        Signal::Node(osc_id),
        Signal::Value(1000.0),
        Signal::Value(10.0),
    );
...
fn test_bpf_chained() {
    ...
    let bpf1_id = graph.add_bandpass_node(
        Signal::Node(osc_id),
        Signal::Value(1000.0),
        Signal::Value(2.0),
    );
    ...
    let bpf2_id = graph.add_bandpass_node(
        Signal::Node(bpf1_id),
        Signal::Value(1000.0),
        Signal::Value(2.0),
    );
