...
fn test_delay_pattern_time() {
    ...
    let code = r#"
        tempo: 0.5
        out $ s "bd*4" # delay (sine 1.0 * 0.2 + 0.1) 0.3
    "#;
...
fn test_reverb_pattern_room_size() {
    ...
    let code = r#"
        tempo: 0.5
        out $ s "sn*2" # reverb (sine 0.25 * 0.5 + 0.3) 0.5
    "#;
...
fn test_distortion_pattern_drive() {
    ...
    let code = r#"
        tempo: 0.5
        out $ s "bd*4" # dist (sine 2.0 * 2.0 + 1.0)
    "#;
...
fn test_multiple_pattern_parameters() {
    ...
    let code = r#"
        tempo: 0.5
        out $ saw 110 # lpf (sine 0.5 * 1500 + 500) 0.8 # dist (sine 2.0 + 1.5) # delay (sine 1.0 * 0.15 + 0.1) 0.3
    "#;
