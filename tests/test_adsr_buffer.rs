...
fn test_adsr_different_attack_times() {
    ...
    // Fast attack
    let fast_id = graph.add_adsr_node(
    ...
    // Slow attack
    let slow_id = graph.add_adsr_node(
...
fn test_adsr_different_sustain_levels() {
    ...
    // High sustain
    let high_id = graph.add_adsr_node(
        Signal::Value(0.001),
        Signal::Value(0.002),
        Signal::Value(0.9),   // 90%
        Signal::Value(0.1),
    ...
    // Low sustain
    let low_id = graph.add_adsr_node(
        Signal::Value(0.001),
        Signal::Value(0.002),
        Signal::Value(0.3),   // 30%
        Signal::Value(0.1),
...
fn test_adsr_sustain_clamping() {
    ...
    let low_id = graph.add_adsr_node(
        Signal::Value(0.001),
        Signal::Value(0.002),
        Signal::Value(-0.5),  // Should clamp to 0.0
        Signal::Value(0.1),
    );
