...
fn test_compressor_reduces_loud_signals() {
    ...
    let comp_id = graph.add_compressor_node(
        loud_signal.clone(),
        Signal::Value(-20.0),  // threshold (dB)
        Signal::Value(4.0),     // ratio
        Signal::Value(0.001),   // attack
        Signal::Value(0.1),     // release
        Signal::Value(0.0),     // makeup gain
    );
...
fn test_compressor_threshold_effect() {
    ...
    let comp_high_thresh = graph.add_compressor_node(
        signal.clone(),
        Signal::Value(-10.0),
        Signal::Value(4.0),
        Signal::Value(0.001),
    ...
    let comp_low_thresh = graph.add_compressor_node(
        signal,
        Signal::Value(-30.0),
        Signal::Value(4.0),
        Signal::Value(0.001),
...
fn test_compressor_ratio_effect() {
    ...
    let comp_low_ratio = graph.add_compressor_node(
        loud_signal.clone(),
        Signal::Value(-20.0),
        Signal::Value(2.0),
        Signal::Value(0.001),
    ...
    let comp_high_ratio = graph.add_compressor_node(
        loud_signal,
        Signal::Value(-20.0),
        Signal::Value(10.0),
        Signal::Value(0.001),
...
fn test_compressor_attack_time() {
    ...
    let comp_fast = graph.add_compressor_node(
        loud_signal.clone(),
        Signal::Value(-20.0),
        Signal::Value(4.0),
        Signal::Value(0.001),
    ...
    let comp_slow = graph.add_compressor_node(
        loud_signal,
        Signal::Value(-20.0),
        Signal::Value(4.0),
        Signal::Value(0.1),
...
fn test_compressor_release_time() {
    ...
    // Fast release
    let comp_fast_rel = graph.add_compressor_node(
        loud_signal.clone(),
        Signal::Value(-20.0),
        Signal::Value(4.0),
        Signal::Value(0.001),
    ...
    // Slow release
    let comp_slow_rel = graph.add_compressor_node(
        loud_signal,
        Signal::Value(-20.0),
        Signal::Value(4.0),
        Signal::Value(0.001),
...
fn test_compressor_makeup_gain() {
    ...
    // No makeup gain
    let comp_no_makeup = graph.add_compressor_node(
        loud_signal.clone(),
        Signal::Value(-20.0),
        Signal::Value(4.0),
        Signal::Value(0.001),
    ...
    let comp_with_makeup = graph.add_compressor_node(
        loud_signal,
        Signal::Value(-20.0),
        Signal::Value(4.0),
        Signal::Value(0.001),
...
fn test_compressor_extreme_ratios() {
    ...
    let comp_min = graph.add_compressor_node(
        loud_signal.clone(),
        Signal::Value(-20.0),
        Signal::Value(1.0),
        Signal::Value(0.001),
    ...
    let comp_max = graph.add_compressor_node(
        loud_signal,
        Signal::Value(-20.0),
        Signal::Value(20.0),
        Signal::Value(0.001),
